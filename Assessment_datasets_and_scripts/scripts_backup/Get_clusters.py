...
bin_to_taxon_dict_f = {}
if taxon_classification_file != None:
    bin_to_taxon_dict_d = get_rank_assignment_dict('d', taxon_classification_file)
    bin_to_taxon_dict_p = get_rank_assignment_dict('p', taxon_classification_file)
    bin_to_taxon_dict_c = get_rank_assignment_dict('c', taxon_classification_file)
    bin_to_taxon_dict_o = get_rank_assignment_dict('o', taxon_classification_file)
    bin_to_taxon_dict_f = get_rank_assignment_dict('f', taxon_classification_file)

print(bin_to_taxon_dict_d)
print(bin_to_taxon_dict_o)
print(bin_to_taxon_dict_f)
...
png_file_group_d =          '%s_grouping_g%s_d.png'       % (output_prefix, group_number)
png_file_group_p =          '%s_grouping_g%s_p.png'       % (output_prefix, group_number)
png_file_group_c =          '%s_grouping_g%s_c.png'       % (output_prefix, group_number)
png_file_group_o =          '%s_grouping_g%s_o.png'       % (output_prefix, group_number)
png_file_group_f =          '%s_grouping_g%s_f.png'       % (output_prefix, group_number)
...
pwd_png_file_group_d =      '%s/%s'                     % (MetaCHIP_wd, png_file_group_d)
pwd_png_file_group_p =      '%s/%s'                     % (MetaCHIP_wd, png_file_group_p)
pwd_png_file_group_c =      '%s/%s'                     % (MetaCHIP_wd, png_file_group_c)
pwd_png_file_group_o =      '%s/%s'                     % (MetaCHIP_wd, png_file_group_o)
pwd_png_file_group_f =      '%s/%s'                     % (MetaCHIP_wd, png_file_group_f)
...
if taxon_classification_file != None:
    ...
    # get plot at Domain level
    bin_to_taxon_dict = bin_to_taxon_dict_d

    plot_clustering_dendrogram(cluster, leaf_font_size, get_taxon, max_d, dendrogram_width, dendrogram_height, pwd_png_file_group_d)

    # get plot at Phylum level
    bin_to_taxon_dict = bin_to_taxon_dict_p
    plot_clustering_dendrogram(cluster, leaf_font_size, get_taxon, max_d, dendrogram_width, dendrogram_height, pwd_png_file_group_p)

    # get plot at Class level
    bin_to_taxon_dict = bin_to_taxon_dict_c
    plot_clustering_dendrogram(cluster, leaf_font_size, get_taxon, max_d, dendrogram_width, dendrogram_height, pwd_png_file_group_c)

    # get plot at Order level
    bin_to_taxon_dict = bin_to_taxon_dict_o
    plot_clustering_dendrogram(cluster, leaf_font_size, get_taxon, max_d, dendrogram_width, dendrogram_height, pwd_png_file_group_o)

    # get plot at Family level
    bin_to_taxon_dict = bin_to_taxon_dict_f
    plot_clustering_dendrogram(cluster, leaf_font_size, get_taxon, max_d, dendrogram_width, dendrogram_height, pwd_png_file_group_f)
