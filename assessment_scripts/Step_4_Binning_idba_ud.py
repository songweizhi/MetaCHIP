...
memory = int(config['STEP_4_BINNING_idba_ud']['qsub_memory_4'])
walltime_needed = config['STEP_4_BINNING_idba_ud']['qsub_walltime_4']
...
pwd_jgi_summarize_bam_contig_depths = config['STEP_4_BINNING_idba_ud']['pwd_jgi_summarize_bam_contig_depths']
modules_metabat = config['STEP_4_BINNING_idba_ud']['qsub_modules_4_metabat']
modules_mycc = config['STEP_4_BINNING_idba_ud']['qsub_modules_4_mycc']
