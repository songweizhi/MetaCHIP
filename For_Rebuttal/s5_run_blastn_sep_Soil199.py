...
qsub_file_folder = '/Users/songweizhi/Desktop/qsub_files_blastn_Soil199'
wd_on_katana = '/srv/scratch/z5039045/MetaCHIP_rebuttal/Soil199_MetaCHIP_wd'
...
# write to qsub files
for taxon_id in open('/Users/songweizhi/Desktop/nature_rebuttal/taxon_id_Soil199.txt'):
    ...
    blastn_cmd = 'blastn -query Soil199_ffn_files/%s.ffn -db Soil199_blastdb/Soil199_combined.ffn -out Soil199_sep_blast_wd/%s_blastn.tab %s' % (taxon_id, taxon_id, blast_parameters)
