...
arrange_order_column_new = ['J', 'A', 'K', 'L', 'B', 'D', 'Y', 'V', 'T', 'M', 'N', 'Z', 'W', 'U', 'O', 'C', 'G', 'E', 'F', 'H', 'I', 'P', 'Q', 'R', 'S']
arrange_order_row_reversed = arrange_order_column_new[::-1]
...
category_id_list = sorted(arrange_order_column_new)
genome_name_list = []
category_num_list = []
...
category_num_arrary = np.array(category_num_list)

# add row and column name to dataframe
category_num_df = pandas.DataFrame(category_num_arrary, index=genome_name_list, columns=category_id_list)

# re-index column order
category_num_df = category_num_df.reindex(arrange_order_column_new, axis=1)
...
#
#
# print(category_num_df['J'])
#
# print(np.array(category_num_df['J']))
#
#
# print(type(np.array(category_num_df['J'])))
#
#
# # plot data
# plt.boxplot(np.array(category_num_df), labels=arrange_order_column_new, showfliers=1)
#
#
...
# fig, axes = plt.subplots(nrows=1, ncols=1, figsize=(24, 6))
#
# boxplot_inputs = [category_num_df['A']]
#
# plt.boxplot(boxplot_inputs)
#
# plt.show()
...
# #print(category_num_df)
#
# category_num_df_transposed = category_num_df.transpose
#
#
#
# #print(category_num_df.transpose)
#
