...
def get_match_category(folder_name, flanking_length, calculation_step, pwd_blastn_exe):
    ...
    print(file_recipient_gene_3000_gbk)
    print(donor_gene)
    print(file_donor_gene_3000_gbk)
...
folder_name = 'AA_Refined_8_00200___DP_Refined_138_00314'

end_break = check_end_break(folder_name, 3000, 1000, 'blastn')
print(end_break)

get_match_category(folder_name, 3000, 1000, 'blastn')
